...
@PlanningSolution
public class EmployeeRoster implements Solution<HardSoftScore> {
    ...
    public void setEmployeeRosterParametrization(EmployeeRosterParametrization nurseRosterParametrization) {
        this.employeeRosterParametrization = nurseRosterParametrization;
    }
    ...
    public void setContractList(List<Contract> contractList2) {
        this.contractList = contractList2;
    }
